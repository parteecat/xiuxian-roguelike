        ...
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-8 pointer-events-none">
            <motion.div
              ...
              className="w-full max-w-lg max-h-[85vh] bg-background border border-[hsl(var(--ink-border))] rounded-2xl flex flex-col overflow-hidden pointer-events-auto shadow-2xl"
            >
              {/* 头部 */}
